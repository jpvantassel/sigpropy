...
class TestTimeSeries(unittest.TestCase):
    ...
    def test_from_trace_seg2(self):
        ...
        tseries = sigpropy.TimeSeries.from_trace_seg2(trace)
    ...
    def test_crosscorr(self):
        ...
        ampb = [1]
        dt = 1
        tseries_a = sigpropy.TimeSeries(ampa, dt)
        tseries_b = sigpropy.TimeSeries(ampb, dt)
        correlate = sigpropy.TimeSeries.crosscorr(tseries_a, tseries_b)
    ...
    def test_crosscorr_shift(self):
        ...
        tseries_a = sigpropy.TimeSeries(ampa, dt)
        tseries_b = sigpropy.TimeSeries(ampb, dt)
        shifted = sigpropy.TimeSeries.crosscorr_shift(tseries_a, tseries_b)
    ...
    def test_cross_stack(self):
        ...
        tseries_a = sigpropy.TimeSeries(ampa, dt)
        tseries_b = sigpropy.TimeSeries(ampb, dt)
        stacked = sigpropy.TimeSeries.from_cross_stack(tseries_a, tseries_b)
